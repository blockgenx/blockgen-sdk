...
```bash
go test -v --bench github.com/blockgenx/blockgen-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/blockgenx/blockgen-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/blockgenx/blockgen-sdk/crypto/keys/mintkey	12.093s
```
