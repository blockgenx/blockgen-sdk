...
HTTPS_GIT := https://github.com/blockgenx/blockgen-sdk/.git
...
ifeq ($(LEDGER_ENABLED),true)
  ifeq ($(OS),Windows_NT)
    ...
    ifeq ($(UNAME_S),OpenBSD)
      $(warning OpenBSD detected, disabling ledger support (https://github.com/blockgenx/blockgen-sdk//issues/1))
    else
...
ldflags = -X github.com/blockgenx/blockgen-sdk//version.Name=sim \
		  -X github.com/blockgenx/blockgen-sdk//version.AppName=simd \
		  -X github.com/blockgenx/blockgen-sdk//version.Version=$(VERSION) \
		  -X github.com/blockgenx/blockgen-sdk//version.Commit=$(COMMIT) \
		  -X "github.com/blockgenx/blockgen-sdk//version.BuildTags=$(build_tags_comma_sep)" \
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/blockgenx/blockgen-sdk//types"
	godoc -http=:6060
...
devdoc-init:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/blockgenx/blockgen-sdk/" -w "/go/src/github.com/blockgenx/blockgen-sdk/" tendermint/devdoc echo
	# TODO make this safer
	$(call DEVDOC_SAVE)

devdoc:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/blockgenx/blockgen-sdk/" -w "/go/src/github.com/blockgenx/blockgen-sdk/" devdoc:local bash
