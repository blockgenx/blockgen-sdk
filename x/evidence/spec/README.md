...
`x/evidence` is an implementation of a Cosmos SDK module, per [ADR 009](https://github.com/blockgenx/blockgen-sdk/blob/main/docs/architecture/adr-009-evidence-module.md),
