...
import (
	...
	"github.com/blockgenx/blockgen-sdk/testutil/rest"
	...
	authtest "github.com/blockgenx/blockgen-sdk/x/auth/client/testutil"
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			if tc.expErr {
				...
				// ref: https://github.com/blockgenx/blockgen-sdk/issues/8680
				// ref: https://github.com/blockgenx/blockgen-sdk/issues/8681
