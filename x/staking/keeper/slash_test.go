...
import (
	...
	"github.com/blockgenx/blockgen-sdk/x/staking/keeper"
	"github.com/blockgenx/blockgen-sdk/x/staking/teststaking"
...
func TestSlashWithUnbondingDelegation(t *testing.T) {
	...
	// this may not be the desirable behaviour, ref https://github.com/blockgenx/blockgen-sdk/issues/1440
	ctx = ctx.WithBlockHeight(13)
	app.StakingKeeper.Slash(ctx, consAddr, 9, 10, fraction)
