...
+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/proto/cosmos/tx/v1beta1/tx.proto#L230-L249
...
+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/proto/cosmos/tx/v1beta1/tx.proto#L219-L228
...
For the tipper, the SDK exposes a new transaction builder, the `AuxTxBuilder`, for generating an `AuxSignerData`. The API of `AuxTxBuilder` is defined [in `client/tx`](https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/client/tx/aux_builder.go#L16), and can be used as follows:
