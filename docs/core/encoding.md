...
```go
import authzcodec "github.com/blockgenx/blockgen-sdk/x/authz/codec"
...
+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/types/tx_msg.go#L72-L76

A standard implementation of both these objects can be found in the [`auth` module](../../x/auth/spec/README.md):

+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/x/auth/tx/decoder.go

+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/x/auth/tx/encoder.go
...
+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/x/auth/types/account.go#L301-L324
...
* the [`Validator`](https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/x/staking/types/staking.pb.go#L306-L339) struct that contains information about a validator.
...
+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/x/staking/types/validator.go#L40-L61
...
+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/codec/types/interface_registry.go#L25-L55
...
+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0/codec/yaml.go#L8-L20

For example:

+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0/x/auth/types/account.go#L139-L151
