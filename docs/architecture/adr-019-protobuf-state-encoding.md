...
* 2021 Feb 24: Remove mentions of `HybridCodec`, which has been abandoned in [#6843](https://github.com/blockgenx/blockgen-sdk/pull/6843).
...
After [extension discussion](https://github.com/blockgenx/blockgen-sdk/issues/6030),
...
```go
import "github.com/blockgenx/blockgen-sdk/codec"
...
message MsgSubmitEvidence {
  bytes submitter = 1
    [
      (gogoproto.casttype) = "github.com/blockgenx/blockgen-sdk/types.AccAddress"
    ];
...
1. https://github.com/blockgenx/blockgen-sdk/issues/4977
2. https://github.com/blockgenx/blockgen-sdk/issues/5444
