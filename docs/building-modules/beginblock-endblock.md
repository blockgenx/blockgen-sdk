...
+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/x/distribution/abci.go#L14-L38

and an example implementation of `EndBlocker` from the `staking` module:

+++ https://github.com/blockgenx/blockgen-sdk/blob/v0.46.0-rc1/x/staking/abci.go#L22-L27
