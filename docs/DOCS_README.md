...
If you want to open a PR in Cosmos SDK to update the documentation, please follow the guidelines in [`CONTRIBUTING.md`](https://github.com/blockgenx/blockgen-sdk/tree/main/CONTRIBUTING.md#updating-documentation).
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/blockgenx/blockgen-sdk/blob/main/client/lcd/swagger-ui/swagger.yaml)
